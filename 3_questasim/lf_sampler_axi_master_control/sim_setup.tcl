...
alias com {
  ...
  vcom -2008 -work zt_lib $SRC/lf_sampler_axi_master_control.vhd  
  
  # Compile Testbench
  vcom -2008 -work zt_tb_lib $TB/tb_lf_sampler_axi_master_control_sim.vhd
  vcom -2008 -work zt_tb_lib $TB/tb_lf_sampler_axi_master_control_top.vhd
}
