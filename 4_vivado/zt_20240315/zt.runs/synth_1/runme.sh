...
HD_PWD='C:/FHNW/prj2/fhnw_zt/4_vivado/zt/zt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lf_sampler_axi_master_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lf_sampler_axi_master_control.tcl
