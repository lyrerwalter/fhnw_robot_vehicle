...
simulate()
{
  xsim bd -key {Behavioral:sim_1:Functional:bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_4a17.protoinst" -protoinst "protoinst_files/bd.protoinst" -log simulate.log
}
