...
HD_PWD='C:/FHNW/prj2/fhnw_zt/4_vivado/zt_20240308/zt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboTank_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboTank_wrapper.tcl -notrace
